...
namespace RemoteObject
{
    public abstract class RemoteObject : MonoBehaviour
    {
        ...
        /// </summary>
        public Dictionary<string, RemoteStateAttribute> StateAttributes;
        /// <summary>
        /// 원격 객체 자신이 할당받은 객체 유형이 가지는 객체 기능 목록
        /// </summary>
        public Dictionary<string, RemoteActionAttribute> ActionAttributes;
        ...
        public virtual bool SetState(string stateID, RemoteStateAttribute newRemoteState)
        {
            // 유효하지 않은 stateID 값
        ...
        public virtual RemoteObject ExecuteAction(string actionID, RemoteActionAttribute newRemoteAction)
        {
            // TODO: 기능 수행
